...
pub fn sync_with_foreign(fdb: &FileDatabase, foreign_server: &mut ForeignServer, own_port: u16) -> Result<()> {
    ...
    Ok(fdb.add_syncpoint(&new_syncpoint)?)
}
...
mod sync_tests {
    ...
    fn file_system_changes_work() {
        ...
        // Apply the changes
        sync_with_foreign(&fdb, &mut foreign_server, 0)
